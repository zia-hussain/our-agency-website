...
export const contactFAQs = [
  {
    question: "How quickly can Zumetrix Labs start my international software development project?",
  ...
  {
    question: "Do you work with international clients across different time zones and markets?",
