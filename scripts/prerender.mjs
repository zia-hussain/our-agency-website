...
const routes = [
  ...
  "/portfolio/knipsr-event-media-saas",
  "/portfolio/liftly-operational-mvp-v1",
  "/portfolio/learning-platform-saas-stabilization",
  ...
  "/portfolio/fast-track-usa-app-rescue",
  "/contact",
  "/articles",
  "/rescue-or-rebuild",
  "/articles/what-we-learned-building-50-projects",
  "/articles/build-saas-mvp-in-30-days",
  "/articles/should-you-rescue-or-rebuild-your-saas",
  "/articles/when-is-ai-automation-the-wrong-choice",
  ...
  "/articles/why-software-projects-get-stuck",
  "/articles/taking-over-a-saas-from-another-dev-team",
  "/articles/signs-your-saas-needs-stabilization-not-rebuild",
  "/articles/decision-room-001-liftly-sequencing",
  "/privacy-policy",
  "/terms-of-service",
  "/unsubscribe",
];
