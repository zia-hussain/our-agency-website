          ...
          <AnimatedSection className="text-center">
            ...
            <div className="max-w-4xl mx-auto">
              <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed font-light mb-6">
                <strong>Zia Hussain</strong> and <strong>Syed Omer Shah</strong> are world-class software developers and the visionary co-founders behind <strong>Zumetrix Labs</strong>, Pakistan's premier software development agency. With deep expertise in React/Node.js development, SaaS MVP building, AI automation services, Firebase integration, and enterprise software solutions, they've successfully delivered 50+ projects for international clients, helping transform ambitious business ideas into profitable digital products that scale globally.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Founded in 2021, <strong>Zumetrix Labs</strong> serves ambitious startups, growing enterprises, and established businesses across the <strong>United States, United Kingdom, European Union, Canada, Australia, UAE, Singapore</strong>, and worldwide. Our founder-led approach ensures every <strong>SaaS MVP</strong>, <strong>React/TypeScript application</strong>, <strong>mobile app</strong>, <strong>AI automation project</strong>, and <strong>custom software solution</strong> receives direct attention from senior-level developers who understand international market requirements, modern tech stacks, and scalable architecture principles.
              </p>
            </div>
          </AnimatedSection>
        </div>
